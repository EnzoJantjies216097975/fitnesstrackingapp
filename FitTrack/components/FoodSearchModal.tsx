...
const FoodSearchModal: React.FC<FoodSearchModalProps> = ({ onSelectFood }) => {
  ...
  const renderFoodItem = ({ item }: { item: FoodItem }) => (
    ...
    >
      ...
      <View style={styles.foodItemCalorieContainer}>
        <Text style={styles.foodItemCalorieValue}>{item.calories}</Text>
        <Text style={styles.foodItemCalorieLabel}>cal</Text>
      </View>
    </TouchableOpacity>
  );
...
const styles = StyleSheet.create({
  ...
  foodItemCalorieContainer: {
    flexDirection: 'row',
    alignItems: 'baseline',
  },
  foodItemCalorieValue: {
    fontSize: 16,
    fontWeight: '500',
  },
  foodItemCalorieLabel: {
    fontSize: 12,
    color: '#757575',
    marginLeft: 2,
  },
